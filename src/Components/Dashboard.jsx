  ...
  return (
    <div>
      <table>
        <thead>
          <tr>
            <th style={{ textAlign: "center", paddingRight: "30px", paddingLeft: "30px" }}>No</th>
            <th style={{ textAlign: "center", paddingRight: "30px", paddingLeft: "30px" }}>ID</th>
            <th style={{ textAlign: "center", paddingRight: "40px", paddingLeft: "40px" }}>Image</th>
            <th style={{ textAlign: "center", paddingRight: "40px", paddingLeft: "40px" }}>
            ...
            <th style={{ textAlign: "center", paddingRight: "40px", paddingLeft: "40px" }}>Confidential Level</th>
            <th style={{ textAlign: "center", paddingRight: "40px", paddingLeft: "40px" }}>
              <div style={{ display: "flex", alignItems: "center" }}>
            ...
            return (
              <tr key={id}>
                ...
                <td style={{ textAlign: "center" }}>
                  {imageUrl && <img src={imageUrl} alt="Pothole Image" width="150" height="100" />}
                </td>
                <td style={{ textAlign: "center" }}>{data[id].location}</td>
                <td style={{ textAlign: "center" }}>{data[id].reportDate}</td>
                <td style={{ textAlign: "center" }}>{data[id].confidentialLevel}</td>
                <td style={{ textAlign: "center" }}>
                  <select value={data[id].repairStatus} onChange={(event) => handleRepairStatusChange(id, event)}>
                ...
                <td style={{ textAlign: "center" }}>{data[id].repairCompletionDate}</td>
                <td style={{ textAlign: "center" }}>
                  <button onClick={() => handleDownloadPDF(id, data[id])}>Download PDF</button>
                </td>
              </tr>
            );
          })}
